  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        "gradient-primary": "linear-gradient(135deg, #E0E0E0 0%, #FFFFFF 100%)",
        "gradient-emerald": "linear-gradient(135deg, #E0E0E0 0%, #FFFFFF 50%, #F5F5F5 100%)",
      ...
      boxShadow: {
        ...
        'glow-white-lg': '0 0 30px rgba(255,255,255,0.4)',
